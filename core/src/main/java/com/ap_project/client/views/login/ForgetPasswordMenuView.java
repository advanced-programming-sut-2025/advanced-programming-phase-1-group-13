package com.ap_project.client.views.login;

import com.ap_project.Main;
import com.ap_project.client.controllers.login.ForgetPasswordMenuController;
...
public class ForgetPasswordMenuView implements Screen {
    ...
    public void show() {
        ...
        table.add(securityQuestion).align(Align.right).padBottom(40).padRight(20);
        table.add(questionText).width(750).padBottom(40).row();

        table.add(answer).align(Align.right).padBottom(40).padRight(20);
        table.add(answerField).width(750).align(Align.right).padBottom(40).row();
