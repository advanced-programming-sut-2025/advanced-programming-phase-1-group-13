...
public class Main extends Game {
    ...
    public static void goToKickMenu(GameView gameView, String username) {
        Main.getMain().setScreen(new KickMenuView(GameAssetManager.getGameAssetManager().getSkin(), gameView, username));
    }

    public static void goToTerminateMenu(GameView gameView) {
        Main.getMain().setScreen(new TerminateMenuView(GameAssetManager.getGameAssetManager().getSkin(), gameView));
    }
    ...
    public static void goToAskForTradeMenu(GameView gameView, String sender) {
        Main.getMain().setScreen(new AskForTradeMenuView(GameAssetManager.getGameAssetManager().getSkin(), gameView, sender));
    }
