...
public enum GoodsType implements ItemType {
    ...
    GOLD_ORE("Gold Ore", "A precious ore that can be smelted into bars.", 400, -1,
            ShopType.BLACKSMITH, List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
    HAY("Hay", "Dried grass used as animal food.", 50, -1, ShopType.MARNIE_RANCH,
    ...
    SHEARS("Shears", "Use this to collect wool from sheep", 1000, 1,
            ShopType.MARNIE_RANCH, List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
    BEER("Beer", "Drink in moderation.", 400, -1, ShopType.THE_STARDROP_SALOON,
            List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
    SALAD("Salad", "A healthy garden salad.", 220, -1, ShopType.THE_STARDROP_SALOON,
            List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
    BREAD("Bread", "A crusty baguette.", 120, -1, ShopType.THE_STARDROP_SALOON,
            List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
    SPAGHETTI("Spaghetti", "An old favorite.", 240, -1, ShopType.THE_STARDROP_SALOON,
            List.of(Season.SPRING, Season.SUMMER, Season.FALL, Season.WINTER)),
